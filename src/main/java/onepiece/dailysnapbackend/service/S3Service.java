...
import onepiece.dailysnapbackend.object.constants.FileExtension;
...
import onepiece.dailysnapbackend.util.config.S3Properties;
...
public class S3Service implements StorageService {
  ...
  private String determinePrefix(UploadType type) {
    return switch (type) {
      ...
      case POST -> s3Properties.s3().path().post();
    };
  }
